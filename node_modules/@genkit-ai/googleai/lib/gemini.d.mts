 ...
 */
declare function defineGoogleAIModel({ ai, name, apiKey, apiVersion, baseUrl, info, defaultConfig, debugTraces, }: {
    ai: Genkit;
    name: string;
    apiKey?: string;
    apiVersion?: string;
